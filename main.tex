...
\defn{}{
    ...
    \[
    \mathcal{F}: \mathfrak{S} \to \mathfrak{S}, h \mapsto \mathcal{F}(h):=\hat{h}, \quad \hat{k}(x) := \int_{\mathbb{R}^n} e^{-2 \pi i k^T y} h (y) d^n y.
    \]
}
