...
\pf{
    ...
    \begin{itemize}
        ...
        \item For $(x,x^\prime) \in \Omega \times \Omega^\prime$ the function $(y,y^\prime,t) \mapsto H_{\Omega \times \Omega^\prime} ((x,x^\prime),(y,y^\prime),t) - \Phi (x-y,t) \Phi (x^\prime-y^\prime ,t)$ solves the homogenuous heat equation and extends continuously to $\bar{\Omega} \times \bar{\Omega}^\prime \times [ii)] \mathbb{R}_0^+$ with $0$ on $\bar{\Omega} \times \bar{\Omega}^\prime \times \{0\}.$
    \end{itemize}
    \begin{itemize}
        \item [i)] Due to $\partial (\Omega \times \Omega^\prime) = (\partial \Omega \times \bar{\Omega}^\prime ) \cup (\bar{\Omega} \times \partial \Omega^\prime)$ we have 
         \[
        \lim_{(x,x^\prime) \to \partial (\Omega \times \Omega^\prime)} H_\Omega (x,y,t) H_{\Omega^\prime} (x^\prime,y^\prime,t) = (\lim_{x \to \partial \Omega} H_\Omega (x,y,t) H_{\Omega^\prime}(x^\prime,y^\prime,t)) + (\lim_{x^\prime \to \partial \Omega^\prime }H_\Omega (x,y,t) H_{\Omega^\prime}(x^\prime,y^\prime,t) )=0.
        \]
        ...
        leads to 
        \begin{align*}
            &\dot{H}_{\Omega} H_{\Omega^\prime} + H_{H} \dot{H}_{\Omega^\prime} - \dot{\Phi} \Phi^\prime - \Phi \dot{\Phi}^\prime - \big( \Delta_\Omega H_\Omega H_{\Omega^\prime} + \Delta_{\Omega^\prime} H_{\Omega^\prime} H_\Omega - \Delta_\Omega \Phi \Phi^\prime - \Delta_{\Omega^\prime } \Phi^\prime \Phi   \big) \\
        ...
        \end{align*}
        where $\dot{\Phi} $ is defined on $\Omega^\prime$. Finally, 
        \begin{align*}
           & \lim_{t \to 0} H_{\Omega \times \Omega^\prime} ((x,x^\prime ) , (y,y^\prime),t) = \lim_{t \to 0} H_\Omega (x,y,t) \lim_{t \to 0} H_{\Omega^\prime} (x^\prime,y^\prime,t)\\
           & = \delta_y (x) \delta_{y^\prime} (x^\prime) = \lim_{t \to 0} \Phi (x-y,t) \lim_{t \to 0} \Phi (x^\prime -y^\prime,t).
        \end{align*}
    \end{itemize}
}
