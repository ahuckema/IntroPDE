...
\[
\{ \sum_{k=-N}^N c_k \left( e^{2 \pi i x} \right)^k \mid c_{-N},...,c_N \in \mathbb{R} \}
\] 
forms an algebra on $\mathbb{C}$ (for $k>0$ we have real values and for $k<0$ complex ones) that seperates points and contains constants. Stone Weierstraß implies that this linear span is dense in $C(\mathbb{R} / \mathbb{Z})$. And with the above and transitivity it is also dense in $L^2 (\mathbb{R}/ \mathbb{Z})$.
and finally that $e^{2 \pi i k x} $ are eigenfunctions of $-\frac{d^2}{dx^2}$, due to 
\[
\frac{d^2}{dx^2} e^{2 \pi i k x} = 4 \pi^2 k^2 e^{2 \pi i k x},
\]
with Eigenvalues $4 \pi^2 k^2 $, it follows with the theorem from Stone Weierstraß and the fact that $\cos ( 2 \pi x) + \sin (2 \pi x) = e^{2 \pi i x}$ that $(\left( e^{2 \pi i x} \right)^k)_{k \in \mathbb{N}}$ is a orthogonal system of $L^2(\mathbb{R}/ \mathbb{Z})$.
\begin{align*}
    &\int_{\mathbb{R} / \mathbb{Z}} H_{\mathbb{R} / \mathbb{Z}} (x,y,t) h(y) d^n y \\
    ...
    &= \sum_{k \in \mathbb{Z}} \int_{\mathbb{R} / \mathbb{Z}} h(y) e^{- 2 \pi i k y} d^n y e^{2 \pi i k x - t 4 \pi^2 k^2 }  \\
    &= \int_{\mathbb{R} / \mathbb{Z}} \sum_{k \in \mathbb{Z}}  h(y) e^{2 \pi i k (x-y) - t 4 \pi^2 k^2 } d^n y ,
\end{align*}
...
\[
H_{\mathbb{R} / \mathbb{Z}} (x,y,t) = \sum_{ k \in \mathbb{Z}} e^{2 \pi i k (x-y) - 2 \pi i k y} =: \Theta (x-y, 4 \pi i t).
\]
...
\[
(x,\tau) \in \mathbb{C} \times \times \{ \tau \in \mathbb{C} \mid \mathfrak{S} (\tau ) >0 \}, \quad \text{where } \mathfrak{S}(4 \pi it) = 4 \pi \mathcal{R}e(it).
\]
