...
\rmkb{
    ...
    \[
    \dot{u}(x,t) + \frac{\partial}{\partial x} f(u(x,t)) = \dot{u} (x,t) + u(x,t) \frac{\partial}{\partial x} u(x,t) =0,
    \]
...
\begin{align*}
    ...
    &=  t  \fint_{\partial B_t (x)} \nabla_x g(z) \cdot \frac{z-x}{t} d \sigma (z) +  \fint_{\partial B_t (x)}(t h(y) + g(y)) d \sigma (y) \\
    &= \fint_{\partial B_t (x)} th(y) + g(y) + \nabla_x g(y) \cdot (y-x) d \sigma (y).
\end{align*}
